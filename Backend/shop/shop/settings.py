...
SECRET_KEY = "django-insecure-n%sh1fb3wled0f-nn#u#^_vs5+33_^&s(0gsfjv!sez(t9!e8v"
...
SIMPLE_JWT = {
    ...
    'USER_ID_FIELD': 'phone',
    'USER_ID_CLAIM': 'phone',
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=24),  # Долгая жизнь токена
    'ROTATE_REFRESH_TOKENS': False,  # Отключаем refresh токены
